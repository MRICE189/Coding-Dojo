class Enemy
{
    ...
    public virtual void Attack()
    {
        ...
        System.Console.WriteLine($"The enemy {randAttack.Name} dealing {randAttack.Damage} damage.");
    }
}
...
class MagicCaster : Enemy
{
    public MagicCaster(string n, int h = 80) : base(n, h)
    {
        ...
        Attacks.Add(new Attack("bonks you with their staff", 15));
    }

    public void Heal(Enemy target)
    {
        target.Health += 40;
        System.Console.WriteLine($"The caster heals {target.Name}, who now has {target.Health} health.");
    }
}