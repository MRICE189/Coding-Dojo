 ...
 */
function groupObjectsKeyFilter(items, key) {
    const returnHash = {}
    for (const object of items) {
        !returnHash.hasOwnProperty(object.category.toLowerCase())
            ? returnHash[object.category.toLowerCase()] = [object]
            : returnHash[object.category.toLowerCase()].push(object)
    }
    return returnHash[key.toLowerCase()]
}
...
console.log(groupObjectsKeyFilter(objects, 'Cute'))
/*****************************************************************************/