...
class SinglyLinkedList {
    ...
    */
    ...
    concat(addList) {
        ...
        // the last node of the list will have .next of null, reassign it to the head of the added list
    ...
    moveMinToFront() {
        ...
        //assign a min value to the start of list and loop through the whole list to find the min 
        ...
        //now that we've found min value, loop through and rearrange with the min node in front
        runner = this.head;
    ...
    splitOnVal(val) {
        ...
        let runner = this.head;
        while (runner.next.next) {
        //stops 1 node before the node in the list containing value
        // then clears runner.next to break the old list into two
...
// console.log(unorderedList.splitOnVal(-3).toArr());
// console.log(unorderedList.splitOnVal(-5).toArr());
// console.log(unorderedList.splitOnVal(20).toArr());
// console.log(emptyList.splitOnVal(-3).toArr());
// console.log(singleNodeList.splitOnVal(1).toArr());
// console.log(singleNodeList.splitOnVal(5).toArr());
